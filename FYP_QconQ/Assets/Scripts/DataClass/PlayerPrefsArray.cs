...
/**
*  \brief
*   - This script is a utility class, meaning this is an extension.
*   - This class is an extension of Unity's pre-existing PlayerPrefs class.
*   - Unity's version doesn't take Vector3s and some arrays so that is why this class was created
***********************************************/
