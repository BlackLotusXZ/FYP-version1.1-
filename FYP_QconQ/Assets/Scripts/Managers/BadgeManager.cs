...
public class BadgeManager : MonoBehaviour
{
    ...
    //Badge 1
    private const int ARCADEATTEMPTS_EASY = 2;
    private const int ARCADEATTEMPTS_MED = 10;
    private const int ARCADEATTEMPTS_HIGH = 20;
    ...
    void UITextHandler()
    {
        switch (BadgeIndex)
        {
            ...
            case 1:
                ...
                Debug.Log(GameControl.handle.player.arcademodeAttempts);
                if (GameControl.handle.player.arcademodeAttempts < ARCADEATTEMPTS_EASY)
                    badgeDescription[1].text = "Next goal: 2 times";
